...
5. INTERACTIVE BEAT PLACEMENT: Include exactly one organic fill-in-the-blank vocabulary query challenge right before the narrative climax beat. You MUST include the exact token "[PAUSE 3 SECONDS]" in one of the dialogue text fields (typically in the Narrator's turn before the answer reveal) to signal where viewers should pause and think. The answer reveal must happen naturally through the Narrator's tracking lines.
